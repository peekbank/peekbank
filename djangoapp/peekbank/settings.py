"""
Django settings for Peekbank project.
...
WSGI_APPLICATION = 'peekbank.wsgi.application'
...
SCHEMA_FILE = os.path.join(BASE_DIR, 'static/peekbank-schema.json')
